...
/**
 * @author: JiangPing Li
 * @date: 2018-09-10 17:30
 */
@Service
public class RedisDaoImpl implements RedisDao<String,Object> {
...
//        log.info("key[" + key + "],obj[" + obj + "]是否存在,boo:" + boo);
    ...
    @Override
    public Set<Object> getSetUnion(String key, Set set) {
    ...
    @Override
    public Set<Object> getSetIntersect(String key, Set set) {
